...
const styles = StyleSheet.create({
  ...
  cardGridSmall: { flexDirection: 'column', gap: 12, alignItems: 'center' } as ViewStyle,
  cardWrap: { flexBasis: '48%', flexGrow: 0, flexShrink: 0 } as ViewStyle,
  cardWrapSmall: { width: '100%', maxWidth: 500, alignSelf: 'center' } as ViewStyle,
