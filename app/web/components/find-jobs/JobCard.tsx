...
const styles = StyleSheet.create({
  card: { flexGrow: 1, minWidth: 240, padding: 20, borderRadius: 12, borderWidth: 1 } as ViewStyle,
  ...
  modalContent: { padding: 24, borderRadius: 12, borderWidth: 1, width: '100%', maxWidth: 400 } as ViewStyle,
  rolePickerContent: { maxWidth: 420 } as ViewStyle,
